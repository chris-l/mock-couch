...
module.exports = function (self) {
  ...
  return function (req, res, next) {
    ...
    db = __(self.databases[req.params.db]).chain().pairs().sortBy(function (i) { return i[0]; }).map(function (item) { item[1]._id = item[0]; return item[1]; }).value();
    ...
    if (useReduce && useGroup) {
      ...
      (function () {
        ...
        groups = __(rows).chain().groupBy(function (row) {
