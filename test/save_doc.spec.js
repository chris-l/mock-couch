...
describe('save_doc', function() {
  ...
  it('should allow to create a new document', function() {
    save_doc.call(mock_mock, { params : { db : 'people', doc : 'player2' }, body : { name : 'sanae', lastname : 'kochiya' } }, res, dummy_function);
  ...
  it('should NOT allow to create a document with the same name of an existing one', function() {
    save_doc.call(mock_mock, { params : { db : 'people', doc : 'miko' }, body : { name : 'sanae', lastname : 'kochiya' } }, res, dummy_function);
  ...
  it('should allow to update a document, requiring to pass the current _rev', function() {
    save_doc.call(mock_mock, { params : { db : 'people', doc : 'miko' }, body : { _rev : '12345', name : 'sanae', lastname : 'kochiya' } }, res, dummy_function);
  ...
  it('should NOT allow to update a document, if the _rev is wrong', function() {
    save_doc.call(mock_mock, { params : { db : 'people', doc : 'miko' }, body : { _rev : '99999', name : 'sanae', lastname : 'kochiya' } }, res, dummy_function);
    expect(mock_mock.databases.people.miko.name).toBe('reimu');

    save_doc.call(mock_mock, { params : { db : 'people', doc : 'miko' }, body : { _rev : null, name : 'sanae', lastname : 'kochiya' } }, res, dummy_function);
    expect(mock_mock.databases.people.miko.name).toBe('reimu');

    save_doc.call(mock_mock, { params : { db : 'people', doc : 'miko' }, body : { _rev : '', name : 'sanae', lastname : 'kochiya' } }, res, dummy_function);
    expect(mock_mock.databases.people.miko.name).toBe('reimu');

    save_doc.call(mock_mock, { params : { db : 'people', doc : 'miko' }, body : { _rev : '123456', name : 'sanae', lastname : 'kochiya' } }, res, dummy_function);
    expect(mock_mock.databases.people.miko.name).toBe('reimu');
  });
